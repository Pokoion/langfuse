...
This repository includes a [GitHub Actions Demo workflow](.github/workflows/github-actions-demo.yml) that demonstrates the core features of GitHub Actions. It is triggered on every `push` event.
